...
public class CloseableTabbedPane extends JTabbedPane {
    private static final long serialVersionUID = -2501841471158277400L;
    ...
    public CloseableTabbedPane(int aTabPlacement, int aTabLayoutPolicy) {
        super(aTabPlacement, aTabLayoutPolicy);
    }

    public CloseableTabbedPane(int aTabPlacement) {
        super(aTabPlacement);
    }
    ...
    private class TabCloseUI implements MouseListener, MouseMotionListener {
        ...
        private int                 closeX    = 0, closeY = 0, meX = 0,
                meY = 0;
        private int                 selectedTab;
        private final int           width     = 8, height = 8;
        private Rectangle           rectangle = new Rectangle(0, 0, width,
                                                      height);

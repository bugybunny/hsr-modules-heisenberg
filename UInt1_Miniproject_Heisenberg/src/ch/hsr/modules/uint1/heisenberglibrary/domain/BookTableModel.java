...
/**
 * Lists all Books in a jTable with Rows: Available, Title, Author and Publisher.
 * 
 * @author twinter
 */
public class BookTableModel extends AbstractTableModel {
	...
	private String[] columnNames = {"Available", "Title", "Author", "Publisher"};
	...
	public void setValueAt(Object value, int aRowIndex, int aColumnIndex) {        
		...
		switch (aColumnIndex){
			case 0: break; //TODO: availability
			case 1: book.setTitle((String) value);
			case 2: book.setAuthor((String) value);
			case 3: book.setPublisher((String) value);
		}
